...
class MSEA(nn.Module):
    def __init__(self,in_channels):
        ...
        self.msea1=MSEABlock(in_channels,3)
        self.msea2=MSEABlock(in_channels,7)
        self.msea3=MSEABlock(in_channels,11)
        self.msea4=MSEABlock(in_channels,15)
        self.msea5=MSEABlock(in_channels,3,nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True),nn.MaxPool2d(kernel_size=2,stride=2))
        self.msea6=MSEABlock(in_channels,11,nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True),nn.MaxPool2d(kernel_size=2,stride=2))
        self.msea7=MSEABlock(in_channels,3,nn.MaxPool2d(kernel_size=2,stride=2),nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True))
        self.msea8=MSEABlock(in_channels,11,nn.MaxPool2d(kernel_size=2,stride=2),nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True))
